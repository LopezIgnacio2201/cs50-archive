...
<div align="center">
  ...
  <img src="https://img.icons8.com/color/96/000000/obsidian.png"/>
...
- [ ] Organize better folders and files inside the project following guidelines and common practices   

### Tasks implemented! 😄 ✓

- [x] Better readme.md file!
...
<p align="center">
  <em>As of April 20, 2023, I started to better document and comment my projects to keep a better track of my progression. Projects prior to this date may seem less professional and poorly (if at all) documented and commented.</em>
</p>

<p align="center">
  <em>Documentation for each project will include the following:</em>
</p>

<ul align="center">
  <li>Date of project creation</li>
  <li>What the project does</li>
  <li>Comments made before starting to write the code used to create the structure of the code itself.</li>
</ul>

<p align="center">
  <em>Please note that while I aim to include all of these points in my documentation, some projects may be missing certain details. Thank you for your understanding.</em>
</p>
...
I'd like to give credit and thanks to the following sources that helped make this project possible:

* [Harvard cs50 course!](https://learning.edx.org/course/course-v1:HarvardX+CS50+X/home)
